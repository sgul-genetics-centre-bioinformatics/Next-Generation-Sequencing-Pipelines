...
externalBAMdir = "/homes/athosnew/Genetics_Centre_Bioinformatics/Exomes/UBAMs"
...
for sample in mySamples:
    ...
    External_Unaligned = "/homes/athosnew/Genetics_Centre_Bioinformatics/Exomes/tmp"
    ...
    BAM_toFASTQ_command = [java, '-jar', picard, 'SamToFastq', 'INCLUDE_NON_PF_READS=true',
                           'INCLUDE_NON_PRIMARY_ALIGNMENTS=false', 'COMPRESSION_LEVEL=0',
    ...
    BWAcommand = [BWAsoftware, 'mem', BWAindex, FASTQ1out, FASTQ2out, '-t', '8', '-R', samHeader, '-o', outputSAM]
